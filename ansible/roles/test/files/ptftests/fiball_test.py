...
Usage:          Examples of how to use:
                ptf --test-dir ptftests fiball_test.FibTest -t 'router_mac="00:02:03:04:05:00";verbose=True;src_port=0;dst_port=1;dst_ip_addr_list=["1.1.1.1","2.2.2.2"]'
'''
