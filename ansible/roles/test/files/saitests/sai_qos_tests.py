...
class PFCtest(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        ...
        print "rx_c_base:", recv_counters_base
        print "tx_c_base:", xmit_counters_base
        print "queue_c:", queue_counters
        ...
        try:
            ...
            print "send_packet:", pkts_num_leak_out + pkts_num_trig_pfc - 1 - margin
            ...
            print "rx_c:", recv_counters
            print "tx_c:", xmit_counters
            print "queue_c:", queue_counters
            # recv port no pfc
            ...
            recv_counters, queue_counters = sai_thrift_read_port_counters(self.client, port_list[src_port_id])
            xmit_counters, queue_counters = sai_thrift_read_port_counters(self.client, port_list[dst_port_id])
            print "rx_c_2:", recv_counters
            print "tx_c_2:", xmit_counters
            print "queue_c:", queue_counters
            # recv port pfc
            assert(recv_counters[pg] > recv_counters_base[pg])
            # recv port no ingress drop
            ...
            print "send_packet:", pkts_num_trig_ingr_drp - pkts_num_trig_pfc - 1 - 2 * margin
...
class PFCXonTest(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        ...
        print "rx_c_base:", recv_counters_base
        print "tx_c_base:", xmit_counters_base
        print "tx_2_c_base:", xmit_2_counters_base
        print "tx_3_c_base:", xmit_3_counters_base
        ...
        try:
            ...
            pkt = simple_tcp_packet(pktlen=default_packet_length,
                                    ...
                                    ip_tos=tos,
                                    ip_ttl=ttl)
            print "send_packet: {} packets to port {}".format(pkts_num_leak_out + pkts_num_trig_pfc - pkts_num_dismiss_pfc, dst_port_id)
            ...
            pkt = simple_tcp_packet(pktlen=default_packet_length,
                                    ...
                                    ip_tos=tos,
                                    ip_ttl=ttl)
            print "send_packet: {} packets to port {}".format(pkts_num_leak_out + margin + pkts_num_dismiss_pfc - 1, dst_port_2_id)
            ...
            pkt = simple_tcp_packet(pktlen=default_packet_length,
                                    ...
                                    ip_tos=tos,
                                    ip_ttl=ttl)
            print "send_packet: {} packets to port {}".format(pkts_num_leak_out + 1, dst_port_3_id)
            ...
            print "rx_c:", recv_counters
            print "tx_c:", xmit_counters
            print "tx_2_c:", xmit_2_counters
            print "tx_3_c:", xmit_3_counters
            # recv port pfc
            assert(recv_counters[pg] > recv_counters_base[pg])
            # recv port no ingress drop
            assert(recv_counters[INGRESS_DROP] == recv_counters_base[INGRESS_DROP])
            ...
            print "rx_c_2:", recv_counters
            print "tx_c_2:", xmit_counters
            print "tx_2_c_2:", xmit_2_counters
            print "tx_3_c_2:", xmit_3_counters
            # recv port pfc
            assert(recv_counters[pg] > recv_counters_base[pg])
            # recv port no ingress drop
            assert(recv_counters[INGRESS_DROP] == recv_counters_base[INGRESS_DROP])
            ...
            xmit_2_counters, queue_counters = sai_thrift_read_port_counters(self.client, port_list[dst_port_2_id])
            xmit_3_counters, queue_counters = sai_thrift_read_port_counters(self.client, port_list[dst_port_3_id])
            print "rx_c_4:", recv_counters
            print "tx_c_4:", xmit_counters
            print "tx_2_c_4:", xmit_2_counters
            print "tx_3_c_4:", xmit_3_counters
            # recv port no pfc
            assert(recv_counters[pg] == recv_counters_base[pg])
            # recv port no ingress drop
            assert(recv_counters[INGRESS_DROP] == recv_counters_base[INGRESS_DROP])
...
class HdrmPoolSizeTest(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        ...
        xmit_counters_base, queue_counters = sai_thrift_read_port_counters(self.client, port_list[dst_port_id])
        print "rx_c_base:", recv_counters_bases
        print "tx_c_base:", xmit_counters_base
        ...
        try:
            ...
            print "send_packet_leak_out:", pkts_num_leak_out
            ...
            for i in range(0, pgs_num):
                ...
                print "send_packet_trig_pfc:", pkts_num_trig_pfc
            ...
            for i in range(0, pgs_num):
                ...
                while (recv_counters[sidx_dscp_pg_tuples[i][2]] == recv_counters_bases[sidx_dscp_pg_tuples[i][0]][sidx_dscp_pg_tuples[i][2]]) and (pkt_cnt < 10):
                    ...
                    # queue_counters value is not of our interest here
                    recv_counters, queue_counters = sai_thrift_read_port_counters(self.client, port_list[src_port_ids[sidx_dscp_pg_tuples[i][0]]])
                    print "rx_c_queue{}_{}:".format(i, pkt_cnt), recv_counters
            ...
            for i in range(0, pgs_num):
                ...
                print "send_packet_{}_hdrm_full:".format(i), pkts_num_hdrm_full if i == pgs_num - 1 else pkts_num_hdrm_partial
                # allow enough time for the dut to sync up the counter values in counters_db
                time.sleep(8)

                recv_counters, queue_counters = sai_thrift_read_port_counters(self.client, port_list[src_port_ids[sidx_dscp_pg_tuples[i][0]]])
                print "rx_c_queue{}:".format(i), recv_counters
            ...
            print "all but the last pg hdrms filled"
            sys.stderr.flush()
            ...
            print "send_packet_{}_ingress_drop:".format(i), 1 + 2 * margin
            # allow enough time for the dut to sync up the counter values in counters_db
            time.sleep(8)
            recv_counters, queue_counters = sai_thrift_read_port_counters(self.client, port_list[src_port_ids[sidx_dscp_pg_tuples[i][0]]])
            print "rx_c_queue{}:".format(i), recv_counters
...
class WRRtest(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        ...
        pkt = simple_tcp_packet(pktlen=default_packet_length,
                    ...
                    ip_id=exp_ip_id,
                    ip_ttl=64)
        if queue_3_num_of_pkts != 0:
            send_packet(self, src_port_id, pkt, queue_3_num_of_pkts)
        print "send_packet_queue_3:", queue_3_num_of_pkts
        ...
        print "send_packet_queue_4:", queue_4_num_of_pkts
        ...
        print "send_packet_queue_0:", queue_0_num_of_pkts
        ...
        print "send_packet_queue_1:", queue_1_num_of_pkts
        ...
        print "send_packet_queue_2:", queue_2_num_of_pkts
        ...
        print "send_packet_queue_5:", queue_5_num_of_pkts
        ...
        print "send_packet_queue_6:", queue_6_num_of_pkts
        ...
        print >> sys.stderr, queue_pkt_counters
        print >> sys.stderr, queue_num_of_pkts
        # Read counters
        print "DST port counters: "
        port_counters, queue_counters = sai_thrift_read_port_counters(self.client, port_list[dst_port_id])
        print "tx_p_c:", port_counters
        print "tx_q_c:", queue_counters
        print >> sys.stderr, map(operator.sub, queue_counters, queue_counters_base)

        # All packets sent should be received intact
        print "queue_0_num_of_pkts:", queue_0_num_of_pkts
        print "queue_1_num_of_pkts:", queue_1_num_of_pkts
        print "queue_2_num_of_pkts:", queue_2_num_of_pkts
        print "queue_3_num_of_pkts:", queue_3_num_of_pkts
        print "queue_4_num_of_pkts:", queue_4_num_of_pkts
        print "queue_5_num_of_pkts:", queue_5_num_of_pkts
        print "queue_6_num_of_pkts:", queue_6_num_of_pkts
        print "total_pkts:", total_pkts
...
class LossyQueueTest(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        ...
        try:
            ...
            print "send_packet:", pkts_num_leak_out + pkts_num_trig_egr_drp - 1 - margin
            # allow enough time for the dut to sync up the counter values in counters_db
            time.sleep(8)
            # get a snapshot of counter values at recv and transmit ports
            # queue counters value is not of our interest here
...
class PGSharedWatermarkTest(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        ...
        try:
            ...
            print "q_wm_res:", q_wm_res
            print "pg_shared_wm_res:", pg_shared_wm_res
            print "pg_headroom_wm_res:", pg_headroom_wm_res
            ...
            if pkts_num_fill_min:
                ...
                # check instead
                assert(0 * cell_size <= pg_shared_wm_res[pg])
